...
/***/ function(module, exports, __webpack_require__) {
	...
	var _winTable = __webpack_require__(1);

	__webpack_require__(2);

	var _chai = __webpack_require__(196);
	...
	var RandomBalls = function () {
	    function RandomBalls(num) {
	        _classCallCheck(this, RandomBalls);
	    ...
	    _createClass(RandomBalls, [{
	        key: 'setup',
	        value: function setup(num) {
	            this.numBalls = [];
	            for (var i = 0; i < num; i++) {
	        ...
	        key: 'draw',
	        value: function draw() {
	            var index = getRandomInt(0, this.numBalls.length);
	...
	var LottoEval = function () {
	    function LottoEval() {
	        _classCallCheck(this, LottoEval);

	        this.numBalls = 5;
	        this.RandomBalls = new RandomBalls();
	    }

	    _createClass(LottoEval, [{
	        key: 'generateBalls',
	        ...
	        value: function generateRow() {
	            ...
	            var PB = LottoEval.generatePB();

	            return LottoEval.createPBObject(balls, PB);
	        }
	    }, {
	        key: 'generateWinner',
	        value: function generateWinner() {
	        ...
	        key: 'findPrize',
	        value: function findPrize(pattern) {

	            var prize = 'No Prize';
	            var val = 0;

	            for (var i = 0; i < _winTable.winTable.length; i++) {
	                var winValue = this.getValue(_winTable.winTable[i].pattern);
	                var patValue = this.getValue(pattern);

	                if (winValue === patValue) {
	                    prize = _winTable.winTable[i].prize;
	                    val = _winTable.winTable[i].val;
	                    break;
	                }
	            }
	        ...
	        value: function normalizePattern(pattern) {
	            ...
	            var count = pattern.length - norm.length;
	        ...
	        key: 'eval',
	        value: function _eval(winNum, rowNum) {

	            var winArr = LottoEval.convert(winNum);
	            var rowArr = LottoEval.convert(rowNum);

	            var winPB = winArr.pop();
	            var rowPB = rowArr.pop();

	            var pattern = [];
	            winArr.forEach(function (value, i) {

	                var found = rowArr.find(function (entry) {
	                    return entry === value;
	                });
	            ...
	            var normPattern = this.normalizePattern(pattern);
	            ...
	            var _findPrize = this.findPrize(normPattern);

	            var prize = _findPrize.prize;
	            var val = _findPrize.val;

	            return { prize: prize, val: val, ticket: rowArr, pattern: pattern };
	        }
	    }], [{
	        key: 'ticketCost',
	        value: function ticketCost() {
	            return 2;
	        }
	    }, {
	        key: 'createPBObject',
	        value: function createPBObject(balls, PB) {
	            ...
	            for (var _i = 0; _i < balls.length; _i++) {
	                for (var j = 0; j < balls.length; j++) {
	                    ...
	                    (0, _chai.assert)(balls[_i] !== balls[j]);
	                }
	            }
	        ...
	        key: 'convert',
	        value: function convert(rowData) {
	            var retArr = [];
	...
	var evaluator = new LottoEval();

	function FindPrize(winNum, rowNum) {
	...
	function play(numRows) {
	    ...
	    var winner = evaluator.generateWinner();
	    var rows = [];
	    ...
	    var totalWin = 0;
	    var fourDollarWins = 0;
	    var sevenDollarWins = 0;
	    var hundredDollarWins = 0;

	    rows.forEach(function (row) {
	        var _FindPrize = FindPrize(winner, row);

	        var prize = _FindPrize.prize;
	        var val = _FindPrize.val;
	        var ticket = _FindPrize.ticket;
	        var pattern = _FindPrize.pattern;
...
/***/ function(module, exports) {
	...
	var winTable = [{ 'prize': 'Grand Prize', val: 10000000, 'pattern': [1, 1, 1, 1, 1, 1] }, { 'prize': 'Million Dollars', val: 1000000, 'pattern': [1, 1, 1, 1, 1, 0] }, { 'prize': 'Fifty Thousand Dollars', val: 50000, 'pattern': [1, 1, 1, 1, 0, 1] }, { 'prize': 'One Hundred Dollars', val: 100, 'pattern': [1, 1, 1, 1, 0, 0] }, { 'prize': 'One Hundred Dollars', val: 100, 'pattern': [1, 1, 1, 0, 0, 1] }, { 'prize': 'Seven Dollars', val: 7, 'pattern': [1, 1, 1, 0, 0, 0] }, { 'prize': 'Seven Dollars', val: 7, 'pattern': [1, 1, 0, 0, 0, 1] }, { 'prize': 'Four Dollars', val: 4, 'pattern': [1, 0, 0, 0, 0, 1] }, { 'prize': 'Four Dollars', val: 4, 'pattern': [0, 0, 0, 0, 0, 1] }, { 'prize': 'Zero Dollars', val: 0, 'pattern': [1, 1, 0, 0, 0, 0] }, { 'prize': 'Zero Dollars', val: 0, 'pattern': [1, 0, 0, 0, 0, 0] }, { 'prize': 'Zero Dollars', val: 0, 'pattern': [0, 0, 0, 0, 0, 0] }];

	exports.winTable = winTable;
